    ...
    <section className="container mx-auto h-screen flex items-center">
      <div className="lg:grid grid-cols-2 gap-x-14">
        <div className="flex flex-col justify-center">
          <h2 className="text-7xl font-bold uppercase text-white mb-5 ">
        ...
        <div className="lg:flex flex-wrap gap-3">
          <div className="lg:w-[260px] lg:h-[255px]">
            <img
              src={banner1}
              alt="Flower"
              className="w-full h-auto lg:h-full rounded-l-[20px] rounded-t-[20px] border border-white"
            />
          </div>
          <div className="lg:w-[330px] h-auto lg:h-[255px]">
            <img
              src={banner2}
              alt="Flower"
          ...
          <div className="lg:w-[330px] lg:h-[255px]">
            <img
              src={banner3}
              alt="Flower"
          ...
          <div className="lg:w-[260px] h-auto lg:h-[255px]">
            <img
              src={banner1}
              alt="Flower"
